    ...
    this.addItem = function(mainPanel, mode, account, inputTypeList, calendarType, callback){
        ...
        if (mode == object._prefix + 'addCourse') {
            ...
            if (stopServicePanel != null) {
                ...
                var targetRabel = stopServiceUnderFollowingConditionsPanel.getElementsByTagName('label')[1];
                ...
                object._console.log(targetRabel);
                targetRabel.appendChild(doNotStopServiceAsExceptionPanel);
