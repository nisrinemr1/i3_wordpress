                ...
                if (schedule.select == true && parseInt(schedule.remainder) >= 0) {
                    ...
                    if (service.stopServiceUnderFollowingConditions == "isNotEqual") {
                        ...
                        if (parseInt(schedule.capacity) != parseInt(schedule.remainder)) {
                            ...
                            /**
                            var endUnixTime = parseInt(schedule.unixTime) + (durationTime * 60);
                            object._console.log('endUnixTime = ' + endUnixTime);
                            (function(schedules, startKey, endUnixTime, service, callback) {
                                
                                for (var i = startKey; i < schedules.length; i++) {
                                    
                                    if (parseInt(schedules[i].unixTime) < endUnixTime) {
                            ...
                            }) (schedules, i, endUnixTime, service, function(key) {
                        ...
                        if (service.doNotStopServiceAsException == "sameServiceIsNotStopped") {
                            ...
                            if (bookedServicesOnDay != null && bookedServicesOnDay[time] != null) {
                                ...
                                if (bookedServicesOnDay[time][service.key] != null && parseInt(bookedServicesOnDay[time][service.key]) > 0) {
