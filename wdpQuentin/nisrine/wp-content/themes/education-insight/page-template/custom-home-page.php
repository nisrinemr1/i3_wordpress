          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                ...
                <p><?php $excerpt = get_the_excerpt(); echo esc_html( education_insight_string_limit_words( $excerpt, 15 )); ?></p>
              </div>
            </div>
          </div>
          <?php $i++; endwhile;
    ...
    <section id="course-cat">
      <div class="container">
        ...
        <div class="row">
          ...
          $page_query = new WP_Query(array( 'category_name' => esc_html($catData1 ,'education-insight')));?>
