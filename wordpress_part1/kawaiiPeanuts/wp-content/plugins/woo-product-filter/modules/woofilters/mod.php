	...
	public function forceProductFilter( $query ) {
		...
		if ( function_exists( 'debug_backtrace' ) ) {
			...
			if ( is_array( $backtrace ) ) {
				$isBlocks = ( isset( $backtrace[5]['class'] ) && 'Automattic\WooCommerce\Blocks\BlockTypes\AbstractProductGrid' === $backtrace[5]['class'] );
				$isAddons = ( isset( $backtrace[7]['class'] ) && 'Essential_Addons_Elementor\Elements\Product_Grid' === $backtrace[7]['class'] );
				if ( $isBlocks || $isAddons ) {
