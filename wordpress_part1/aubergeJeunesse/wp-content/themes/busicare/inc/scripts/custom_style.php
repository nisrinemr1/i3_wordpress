...
<style>
    ...
    <?php if (get_theme_mod('apply_sibar_link_hover_clr_enable', false) == true): ?>
        body .sidebar .widget .widget-title, body .sidebar .widget .wp-block-search__label, body .sidebar .widget h2 , body.dark .sidebar .widget h2{
    ...
    <?php } if ($theme->name == 'BusiCare'){$logo_custom_width='';} else{$logo_custom_width='225';} ?>
.custom-logo{width: <?php echo intval(get_theme_mod('busicare_logo_length',$logo_custom_width));?>px; height: auto;}
